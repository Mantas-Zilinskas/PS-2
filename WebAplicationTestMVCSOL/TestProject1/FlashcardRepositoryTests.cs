...
public class FlashcardRepositoryTests
{
    ...
    [TestMethod]
    public void GetAllBySetName_ShouldReturnAllFlashcardsOfSet()
    {
        ...
        var retrievedFlashcards = _repository.GetAllBySetName("Math");

        Assert.AreEqual(2, retrievedFlashcards.Count);
        Assert.IsTrue(retrievedFlashcards.All(f => f.SetName == "Math"));
    }
